...
import 'package:expense_tracker/widget/chart_bar/chart_bar.dart';
...
class Chart extends StatelessWidget {
  ...
  List<ExpenseStructureBucket> get buckets {
    return [
      ExpenseStructureBucket.forCategory(expense, Category.food),
      ExpenseStructureBucket.forCategory(expense, Category.leisure),
      ExpenseStructureBucket.forCategory(expense, Category.travel),
      ExpenseStructureBucket.forCategory(expense, Category.work),
    ];
  }
